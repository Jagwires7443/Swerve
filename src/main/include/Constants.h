...
namespace physical
{
    ...
    constexpr double kFrontLeftAlignmentOffset = -280_deg;
    constexpr double kFrontRightAlignmentOffset = -309_deg;
    constexpr double kRearLeftAlignmentOffset = -332_deg;
    constexpr double kRearRightAlignmentOffset = -276_deg;
