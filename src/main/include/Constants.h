...
namespace physical
{
    ...
    constexpr int kFrontLeftAlignmentOffset = -280;
    constexpr int kFrontRightAlignmentOffset = -309;
    constexpr int kRearLeftAlignmentOffset = -332;
    constexpr int kRearRightAlignmentOffset = -276;
